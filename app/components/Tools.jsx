...
>
  <div className="relative z-10 h-full top-0 flex flex-col items-center justify-center w-full lg:w-10/12 m-auto">
    <Animated className="text-4xl font-bold uppercase text-center py-24">
      NUESTRAS HERRAMIENTAS
    </Animated>
    <Animated className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-7xl mx-4 px-4">
